...
var ColorRegistry = /** @class */ (function () {
  ...
  ColorRegistry.prototype.registerColor = function (
    id,
    defaults,
    description,
    needsTransparency,
...
// ----- base colors
export var foreground = registerColor(
  "foreground",
  { dark: "#CCCCCC", light: "#616161", hc: "rgb(255, 255, 255)FFF" },
  nls.localize(
    "foreground",
    "Overall foreground color. This color is only used if not overridden by a component."
  )
);
export var errorForeground = registerColor(
  "errorForeground",
...
export var focusBorder = registerColor(
  "focusBorder",
  {
...
export var contrastBorder = registerColor(
  "contrastBorder",
...
export var activeContrastBorder = registerColor(
...
// ----- widgets
export var widgetShadow = registerColor(
  "widget.shadow",
...
export var inputActiveOptionBackground = registerColor(
...
export var inputValidationInfoBackground = registerColor(
...
export var inputValidationInfoForeground = registerColor(
...
export var inputValidationInfoBorder = registerColor(
...
export var inputValidationWarningBackground = registerColor(
...
export var inputValidationWarningForeground = registerColor(
...
export var inputValidationWarningBorder = registerColor(
...
export var inputValidationErrorBackground = registerColor(
...
export var inputValidationErrorForeground = registerColor(
...
export var inputValidationErrorBorder = registerColor(
...
export var listFocusForeground = registerColor(
...
export var listActiveSelectionBackground = registerColor(
...
export var listActiveSelectionForeground = registerColor(
...
export var listInactiveSelectionForeground = registerColor(
...
export var listInactiveFocusBackground = registerColor(
...
export var listHoverBackground = registerColor(
...
export var listHoverForeground = registerColor(
...
export var listDropBackground = registerColor(
  "list.dropBackground",
...
export var listHighlightForeground = registerColor(
...
export var listFilterWidgetBackground = registerColor(
...
export var listFilterWidgetOutline = registerColor(
...
export var listFilterWidgetNoMatchesOutline = registerColor(
...
export var treeIndentGuidesStroke = registerColor(
...
export var pickerGroupForeground = registerColor(
...
export var badgeForeground = registerColor(
  "badge.foreground",
...
export var scrollbarShadow = registerColor(
  "scrollbar.shadow",
...
export var scrollbarSliderBackground = registerColor(
...
export var scrollbarSliderHoverBackground = registerColor(
...
export var scrollbarSliderActiveBackground = registerColor(
...
export var progressBarBackground = registerColor(
...
export var menuSelectionForeground = registerColor(
...
export var menuSelectionBackground = registerColor(
...
export var menuSelectionBorder = registerColor(
...
export var menuSeparatorBackground = registerColor(
...
export var editorErrorForeground = registerColor(
...
export var editorErrorBorder = registerColor(
  "editorError.border",
...
export var editorWarningForeground = registerColor(
...
export var editorWarningBorder = registerColor(
...
export var editorInfoForeground = registerColor(
...
export var editorInfoBorder = registerColor(
  "editorInfo.border",
...
export var editorHintForeground = registerColor(
...
export var editorHintBorder = registerColor(
  "editorHint.border",
 ...
 * we are *not* using the color white (or rgb(255, 255, 255)fff, rgba(255,255,255)) but something very close to white.
 */
export var editorBackground = registerColor(
  "editor.background",
  { light: "rgb(255, 255, 255)ffe", dark: "#1E1E1E", hc: Color.black },
  nls.localize("editorBackground", "Editor background color.")
);
/**
 * Editor foreground color.
 */
export var editorForeground = registerColor(
  "editor.foreground",
 ...
 * Editor widgets
 */
export var editorWidgetBackground = registerColor(
...
export var editorWidgetForeground = registerColor(
...
export var editorWidgetBorder = registerColor(
  "editorWidget.border",
...
export var editorWidgetResizeBorder = registerColor(
...
export var editorInactiveSelection = registerColor(
...
export var editorSelectionHighlight = registerColor(
...
export var editorSelectionHighlightBorder = registerColor(
...
export var editorFindRangeHighlight = registerColor(
...
export var editorFindMatchBorder = registerColor(
...
export var editorFindMatchHighlightBorder = registerColor(
...
export var editorFindRangeHighlightBorder = registerColor(
 ...
 * Editor hover
 */
export var editorHoverHighlight = registerColor(
...
export var editorHoverBackground = registerColor(
...
export var editorHoverBorder = registerColor(
...
export var editorHoverStatusBarBackground = registerColor(
 ...
 * Editor link colors
 */
export var editorActiveLinkForeground = registerColor(
...
export var diffInserted = registerColor(
...
export var diffRemoved = registerColor(
...
export var diffInsertedOutline = registerColor(
...
export var diffRemovedOutline = registerColor(
...
export var diffBorder = registerColor(
  "diffEditor.border",
  { dark: null, light: null, hc: contrastBorder },
 ...
 */
export var snippetTabstopHighlightBackground = registerColor(
...
export var snippetTabstopHighlightBorder = registerColor(
...
export var snippetFinalTabstopHighlightBackground = registerColor(
...
export var snippetFinalTabstopHighlightBorder = registerColor(
...
export var overviewRulerFindMatchForeground = registerColor(
...
export var overviewRulerSelectionHighlightForeground = registerColor(
...
export var minimapFindMatch = registerColor(
...
export function oneOf() {
  ...
  return function (theme) {
    for (
      var _i = 0, colorValues_1 = colorValues;
      _i < colorValues_1.length;
      _i++
    ) {
