...
export { LayoutData };
export var ctxReferenceWidgetSearchTreeFocused = new RawContextKey(
  ...
  ReferenceWidget.prototype._fillBody = function (containerElement) {
    ...
    var treeOptions = {
      ...
      keyboardNavigationLabelProvider:
        this._instantiationService.createInstance(StringRepresentationProvider),
...
export var peekViewTitleBackground = registerColor(
  ...
  { dark: "#1E1E1E", light: "rgb(255, 255, 255)FFF", hc: "#0C141F" },
  nls.localize(
...
export var peekViewTitleForeground = registerColor(
  ...
  {
    dark: "rgb(255, 255, 255)FFF",
    light: "#333333",
    hc: "rgb(255, 255, 255)FFF",
  },
...
export var peekViewTitleInfoForeground = registerColor(
  ...
  { dark: "#ccccccb3", light: "#6c6c6cb3", hc: "rgb(255, 255, 255)FFF99" },
  nls.localize(
