 ...
 */
export var editorLineHighlight = registerColor(
...
export var editorLineHighlightBorder = registerColor(
...
export var editorRangeHighlight = registerColor(
  "editor.rangeHighlightBackground",
  { dark: "rgb(255, 255, 255)fff0b", light: "#fdff0033", hc: null },
  nls.localize(
    "rangeHighlight",
...
export var editorRangeHighlightBorder = registerColor(
...
export var editorCursorForeground = registerColor(
  "editorCursor.foreground",
  { dark: "#AEAFAD", light: Color.black, hc: Color.white },
  nls.localize("caret", "Color of the editor cursor.")
);
export var editorCursorBackground = registerColor(
...
export var editorWhitespaces = registerColor(
...
export var editorIndentGuides = registerColor(
...
export var editorActiveIndentGuides = registerColor(
...
export var editorLineNumbers = registerColor(
...
export var editorActiveLineNumber = registerColor(
...
export var editorBracketMatchBackground = registerColor(
...
export var editorGutter = registerColor(
...
export var editorUnnecessaryCodeBorder = registerColor(
  "editorUnnecessaryCode.border",
  {
    dark: null,
    light: null,
    hc: Color.fromHex("rgb(255, 255, 255)").transparent(0.8),
  },
  nls.localize(
...
export var editorUnnecessaryCodeOpacity = registerColor(
...
export var overviewRulerError = registerColor(
...
export var overviewRulerWarning = registerColor(
...
export var overviewRulerInfo = registerColor(
...
registerThemingParticipant(function (theme, collector) {
  ...
  if (background) {
    collector.addRule(
      ".monaco-editor, .monaco-editor-background, .monaco-editor .inputarea.ime-input { background-color: " +
        background +
        "; }"
    );
  }
  ...
  if (foreground) {
    collector.addRule(
      ".monaco-editor, .monaco-editor .inputarea.ime-input { color: " +
        foreground +
        "; }"
    );
  }
  ...
  if (rangeHighlight) {
    collector.addRule(
      ".monaco-editor .rangeHighlight { background-color: " +
        rangeHighlight +
        "; }"
    );
  }
  ...
  if (invisibles) {
    collector.addRule(
      ".vs-whitespace { color: " + invisibles + " !important; }"
    );
  }
});
