...
var Trait = /** @class */ (function () {
  ...
  Trait.prototype.splice = function (start, deleteCount, elements) {
    ...
    var indexes = this.sortedIndexes
      .filter(function (i) {
        return i < start;
      })
      .concat(
    ...
    var onChar = Event.chain(domEvent(this.view.domNode, "keydown"))
      ...
      .filter(
        this.keyboardNavigationLabelProvider.mightProducePrintableCharacter
          ? function (e) {
              return _this.keyboardNavigationLabelProvider.mightProducePrintableCharacter(
                e
              );
            }
          : function (e) {
...
var defaultStyles = {
  ...
  listActiveSelectionForeground: Color.fromHex("rgb(255, 255, 255)FFF"),
  listFocusAndSelectionBackground: Color.fromHex("#094771"),
  listFocusAndSelectionForeground: Color.fromHex("rgb(255, 255, 255)FFF"),
...
var List = /** @class */ (function () {
  function List(container, virtualDelegate, renderers, _options) {
    ...
    if (_options.accessibilityProvider) {
      baseRenderers.push(
        new AccessibiltyRenderer(_options.accessibilityProvider)
      );
    }
    ...
    this.styleController =
      _options.styleController ||
      new DefaultStyleController(this.styleElement, this.view.domId);
  ...
  List.prototype._onFocusChange = function () {
    ...
    if (focus.length > 0) {
      this.view.domNode.setAttribute(
        ...
        this.view.getElementDomId(focus[0])
      );
    } else {
